...
function readparam(lc::Int=1)
  ...
  if lc == 1
    ...
    param[27] = 0.5                     # drainage_class                            1.0
    ...
    param[32] = 30                      # the_height_to_measure_wind_speed          37
  ...
  elseif lc == 13
    ...
    param[14] = 0.94                    # albedo_new_snow_vis                       0.94
    param[15] = 0.8                     # albedo_new_snow_nir                       0.80
    param[16] = 100.0                   # density_now_snow                          1000
  ...
  elseif lc == 40
    ...
    param[15] = 0.8                     # albedo_new_snow_nir                       0.80
    param[16] = 100.0                   # density_now_snow                          100.0
    param[17] = 0.04                    # z00 roughness length for heat    ../10   
    param[18] = 2700                    # specific_heat_overstory                   2700.0
